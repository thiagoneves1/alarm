...
class IOSAlarm {
  ...
  static const MethodChannel _methodChannel = MethodChannel('com.thiagoneves.alarm');
  ...
  static Future<void> _handleMethodCall(MethodCall call) async {
    ...
    switch (call.method) {
      case 'stopAlarm':
        if (id != null) {
          print('Flutter Stopping alarm with id $id');
        }
        break;
      case 'snoozeAlarm':
        if (id != null) {
          print('Flutter Snoozing alarm with id $id');
        }
        break;
      case 'confirmAlarm':
        if (id != null) {
          print('Flutter Confirming alarm with id $id');
        }
        break;
      default:
